namespace WebStudy.Data.Repositories
{
    ...
    public class CountryRepository : GenericRepository<Country>, ICountryRepository
    {
        ...
        private readonly IStringLocalizer<CountriesController> localizer;

        public CountryRepository(DataContext context, IStringLocalizer<CountriesController> localizer) : base(context)
        {
        ...
        public IEnumerable<SelectListItem> GetComboCountries()
        {
            ...
            {
                Text = this.localizer["SelectCountry"],
                Value = "0"
            });
        ...
        public IEnumerable<SelectListItem> GetComboCities(int conuntryId)
        {
            ...
            list.Insert(0, new SelectListItem
            {
                Text = this.localizer["SelectCity"],
                Value = "0"
            });
